...
// Rendered only on the client — avoids edge-runtime SSR crashes
...
// Thin wrapper — SSR (edge) only renders a spinner.
// Full component mounts after client hydration.
export default function DeviceDetailPage() {
  ...
  return <DeviceContent id={id as string} />;
}
